 ...
 * European-style 24 hour clock. The clock shows hours and minutes (and seconds now!). The
 * range of the clock is 00:00 (midnight) to 23:59 (one minute before 
 * midnight).
 * 
 * The clock display receives "ticks" (via the timeTick method) every second
 * and reacts by incrementing the display. This is done in the usual clock
 * fashion: the minutes increment when the seconds roll over to zero and the hour increments when the minutes roll over to zero.
 * 
